...
do
	...
	do 
		...
		do
			...
			echo "ngpus ${ngpus} b 2 s ${s} n ${n} d 128 p2p ag bf16 split ${backend}"
			...
			echo "ngpus ${ngpus} b 2 s ${s} n ${n} d 128 p2p rs bf16 split ${backend}"
			...
			echo "ngpus ${ngpus} b 2 s ${s} n ${n} d 128 p2p ag fp8 split ${backend}"
			...
			echo "ngpus ${ngpus} b 2 s ${s} n ${n} d 128 p2p rs fp8 split ${backend}"
			...
			echo "ngpus ${ngpus} b 2 s ${s} n ${n} d 128 p2p rs fp8 atomic ${backend}"
